...
urlpatterns = [
    ...
    path('avaliacao/avaliacao.html', avaliacao, name='avaliacao'),
    ...
    path('semestre/semestre.html', semestres, name='semestres'),
    path('disciplinas/disciplinas.html', disciplinas, name='disciplinas'),
    path('matriculas/matriculas.html', matriculas, name='matriculas'),
